...
if __name__ == "__main__":
    ...
    # final check
    not_null = ["origin_country", "resident_country", "application_state",
                "application_city", "arrival_date", "i94mode_value", "i94visa_value",
                "count"]
    unique_key = ["origin_country", "resident_country", "application_state",
                "application_city", "arrival_date", "i94mode_value", "i94visa_value"]
    immigration_df = spark.read.format("delta").load('s3a://gold-layer-udacity-nd/grouped_immigration_data')
